...
## [2.0.3](https://github.com/Lory99/haelan/compare/v2.3.0...v2.0.3) (2026-09-22)


### Features

* a console tool for the password reset this app has never had ([#131](https://github.com/Lory99/haelan/issues/131)) ([21cdf17](https://github.com/Lory99/haelan/commit/21cdf17e26abdd9bb16d8119751c8e426e6e0005))
* a recovery index, haelan's own version of a score no API will hand over ([#296](https://github.com/Lory99/haelan/issues/296)) ([a9e0ab3](https://github.com/Lory99/haelan/commit/a9e0ab35a9814cc6d584b3c73f6ce6331ab2da91))
* a source that has stopped reporting says so ([#246](https://github.com/Lory99/haelan/issues/246)) ([517c2da](https://github.com/Lory99/haelan/commit/517c2dad7345a80391d3fbe5a472c4ce73a5aaa6))
* a source that stopped inside the range says so on the page ([#250](https://github.com/Lory99/haelan/issues/250)) ([52c754b](https://github.com/Lory99/haelan/commit/52c754b7676555b706f0f9f12834298c2564745b))
* an account's name, username, timezone and password can be changed after it is created ([#136](https://github.com/Lory99/haelan/issues/136)) ([b6153bf](https://github.com/Lory99/haelan/commit/b6153bf6b0325f9abab48bf9ffdb686ff76740f9))
* **core,server,web:** a person whose rebuild failed is finally told so ([#285](https://github.com/Lory99/haelan/issues/285)) ([e91fe35](https://github.com/Lory99/haelan/commit/e91fe352db91ccf4b843fef75531deb49737403c))
* **core:** a browser safe metrics subpath, so pages stop copying the catalogue ([#69](https://github.com/Lory99/haelan/issues/69)) ([24cf29d](https://github.com/Lory99/haelan/commit/24cf29de264b0734ab92843dad7c9cd51693fd19))
* **core:** M1a store, schema, credentials and raw archive ([#12](https://github.com/Lory99/haelan/issues/12)) ([5995f8e](https://github.com/Lory99/haelan/commit/5995f8e7f862c36c6d3c4cdc002b462513917500))
* **core:** M1b API client, catalogue and field mapping ([#14](https://github.com/Lory99/haelan/issues/14)) ([d9f1088](https://github.com/Lory99/haelan/commit/d9f10882d2513db8b4be5cbed04a640d18f611fb))
* **core:** M1c sync engine, day aligned windows and per row sources ([#19](https://github.com/Lory99/haelan/issues/19)) ([885551a](https://github.com/Lory99/haelan/commit/885551a47f34c416572d2d0f03222bcaf5098f56))
* **core:** M2a metric catalogue, daily rollups and the derive queue ([#38](https://github.com/Lory99/haelan/issues/38)) ([21e4801](https://github.com/Lory99/haelan/commit/21e480155b5a25e1e9c743568a815cca269f83bd))
* **core:** M2b source priority, merged daily rows and overrides at derivation ([#45](https://github.com/Lory99/haelan/issues/45)) ([9c5c4fb](https://github.com/Lory99/haelan/commit/9c5c4fbed6aac840b2ee60e6b8b5f2ada1d38e7e))
* **core:** M2c sleep derivation, night assembly and nap detection ([#50](https://github.com/Lory99/haelan/issues/50)) ([182a726](https://github.com/Lory99/haelan/commit/182a726b7e66310084db6b2a6e40e2ff1dd544dd))
* **core:** M2d baselines, insight suppression and the person bound query layer ([#51](https://github.com/Lory99/haelan/issues/51)) ([9be53d1](https://github.com/Lory99/haelan/commit/9be53d1ece4b64784e5eaf6c298ab473925fae88))
* **core:** M2e rebuild from tier 1 with re-resolved source identity ([#55](https://github.com/Lory99/haelan/issues/55)) ([d746833](https://github.com/Lory99/haelan/commit/d7468339f1d4f87505b6a50d81f28f316b948c18))
* **core:** one unreplayable page costs that page, not the whole archive ([#288](https://github.com/Lory99/haelan/issues/288)) ([7dfd3ad](https://github.com/Lory99/haelan/commit/7dfd3adc43bf6598a6031eaf94f120807abd4f61))
* **core:** the detail page spine, and the archive re-mapped onto it ([#141](https://github.com/Lory99/haelan/issues/141)) ([3eb7ff7](https://github.com/Lory99/haelan/commit/3eb7ff7dcd016a79163bf12e9f63dc0ec45f1e42))
* **core:** the query layer M4a's agent surfaces read through ([#138](https://github.com/Lory99/haelan/issues/138)) ([73de283](https://github.com/Lory99/haelan/commit/73de28374a0af671d341cccb0a5369520c590e86))
* **demo:** a browsable demo, recorded from the real app and served as static files ([#215](https://github.com/Lory99/haelan/issues/215)) ([7c62858](https://github.com/Lory99/haelan/commit/7c62858773bfe021cb49e5b0815130495c910c7b))
* draw a workout's GPS route, read from Health Connect ([#328](https://github.com/Lory99/haelan/issues/328)) ([8c37bba](https://github.com/Lory99/haelan/commit/8c37bba74fdd55699375729230bcf0070518a09f))
* haelan installs into a Proxmox LXC without Docker ([#229](https://github.com/Lory99/haelan/issues/229)) ([d957716](https://github.com/Lory99/haelan/commit/d957716893fc51e04aea734de354eb7566f02567))
* Haelan's own cardio load, and the per-split heart rate the watch never wrote ([#191](https://github.com/Lory99/haelan/issues/191)) ([dd4a15a](https://github.com/Lory99/haelan/commit/dd4a15afc2d8837d2a46f5a94bf8294572354192))
* how many backups to keep, and how often, become settings rather than variables ([#205](https://github.com/Lory99/haelan/issues/205)) ([b2cd24b](https://github.com/Lory99/haelan/commit/b2cd24bb17f4db3537c2227975944f4ced980946)), closes [#150](https://github.com/Lory99/haelan/issues/150)
* M1d wizard, accounts and the setup flow ([#21](https://github.com/Lory99/haelan/issues/21)) ([9254125](https://github.com/Lory99/haelan/commit/92541255a45a1fa510742e3365f78ce4699ee57b))
* **probe:** M0 auth probe, answers scope, field paths and volume ([#11](https://github.com/Lory99/haelan/issues/11)) ([3f17ebc](https://github.com/Lory99/haelan/commit/3f17ebcd9ee35e8c447d6beffaa02e7ed6b35045))
* say when a route exists and Health Connect would not release it ([#332](https://github.com/Lory99/haelan/issues/332)) ([170af16](https://github.com/Lory99/haelan/commit/170af16011a983e7697a6a773f5afc2280697619))
* say which of your sources wins a contested day ([#279](https://github.com/Lory99/haelan/issues/279)) ([7ec89bb](https://github.com/Lory99/haelan/commit/7ec89bb6375ae4794f12f35575782d35bde4c601))
* **server:** M3b-2 HTTP surface, ten person bound reads behind one guard ([#67](https://github.com/Lory99/haelan/issues/67)) ([15c8a8b](https://github.com/Lory99/haelan/commit/15c8a8bf40d92b572d34eee4d0f8473e868e99ce))
* **server:** thirteen tools and an MCP server on stdio ([#144](https://github.com/Lory99/haelan/issues/144)) ([0faee79](https://github.com/Lory99/haelan/commit/0faee798f8caa33c9fe36524843fb8e199b97b2e))
* **site:** a landing page, published to GitHub Pages on every release ([#212](https://github.com/Lory99/haelan/issues/212)) ([b716193](https://github.com/Lory99/haelan/commit/b7161938a9ea4e2933806d41ef055a98ab7a9762))
* sql_query, over a projection nothing else is in ([#164](https://github.com/Lory99/haelan/issues/164)) ([79e8b2d](https://github.com/Lory99/haelan/commit/79e8b2d2a3e89c80fa5c589a8b60080c855d4720))
* tell an admin when a newer release is out, if they ask for it ([#269](https://github.com/Lory99/haelan/issues/269)) ([d30ddff](https://github.com/Lory99/haelan/commit/d30ddff0398bbfb87174a2b9ed1d95e2b33d13ef))
* the agent surface over HTTP, behind a token that belongs to one person ([#159](https://github.com/Lory99/haelan/issues/159)) ([df7a3e2](https://github.com/Lory99/haelan/commit/df7a3e241e8b93df507484947a840b7881669558))
* the all-time page, and what only the archive can answer ([#253](https://github.com/Lory99/haelan/issues/253)) ([6da32e3](https://github.com/Lory99/haelan/commit/6da32e383a8efaa16f15ef23d7f0c14d69a30212))
* the landing page's screenshots open full size, and cannot drift from the README ([#239](https://github.com/Lory99/haelan/issues/239)) ([4e5e65b](https://github.com/Lory99/haelan/commit/4e5e65b9ccd7b6d89dfde36102cadd4300dd600b))
* the maintenance card can download the latest backup ([#243](https://github.com/Lory99/haelan/issues/243)) ([bc990ad](https://github.com/Lory99/haelan/commit/bc990adcb285ae28c75fc70a05ee4da673452454))
* the members card says who the admin is, and how each member is doing ([#271](https://github.com/Lory99/haelan/issues/271)) ([f59d2fa](https://github.com/Lory99/haelan/commit/f59d2fa4ca1b237c2ebb5df59b05dfb631a9ca2e))
* the records a session holds, and the device that set a record ([#256](https://github.com/Lory99/haelan/issues/256)) ([a4d6515](https://github.com/Lory99/haelan/commit/a4d6515b0f725d29b6172df7ba9baf7e027cb11d))
* **tokens:** chart tokens with enforced colour blindness and contrast checks ([1f6f468](https://github.com/Lory99/haelan/commit/1f6f4688908c666a0c1a6e156d1ed6e6c010b1d3))
* **tokens:** colour conversion, cvd simulation and contrast ([7bcc2bb](https://github.com/Lory99/haelan/commit/7bcc2bb8b665b3eefd352e3b4bc676f3c9b599f9))
* **tokens:** emit css custom properties for both themes ([36c031c](https://github.com/Lory99/haelan/commit/36c031c41a218be1abdc90190df846715a13dac9))
* **tokens:** primitive and semantic layers for both themes ([800cfc5](https://github.com/Lory99/haelan/commit/800cfc58a5147f35e51e7e0db1bef1dc0be9c5b4))
* **tokens:** raise the type scale floor to 12px ([b0426ac](https://github.com/Lory99/haelan/commit/b0426ac734771b3fac5711b92ef682c955ea4fd1))
* **web:** a card with nothing to show renders nothing at all ([#293](https://github.com/Lory99/haelan/issues/293)) ([cea5f18](https://github.com/Lory99/haelan/commit/cea5f185a7fa7564f9098e4b00fbabc34aead370))
* **web:** a day tile says how that day sat against your own usual ([#262](https://github.com/Lory99/haelan/issues/262)) ([3072a58](https://github.com/Lory99/haelan/commit/3072a586d950f8c748478b10011bf31e79a6e22a))
* **web:** a readable sessions list, a fitted sleep axis, and a rail that follows the pages you keep ([#265](https://github.com/Lory99/haelan/issues/265)) ([97b4d53](https://github.com/Lory99/haelan/commit/97b4d53132e3f8305448df474f3d2f0b54262ef5))
* **web:** a recovery tile that fills its card, and one card for the zone minutes ([#338](https://github.com/Lory99/haelan/issues/338)) ([b5e7eb2](https://github.com/Lory99/haelan/commit/b5e7eb2ff5292e5c18892ec59b19fe03244bdda3))
* **web:** a weekly cardio load target and an acute to chronic workload ratio ([#203](https://github.com/Lory99/haelan/issues/203)) ([4f9b5a9](https://github.com/Lory99/haelan/commit/4f9b5a9095c575e977cdb901e2d3b7ac3e3dcf58))
* **web:** app shell built from semantic tokens only ([268aa9c](https://github.com/Lory99/haelan/commit/268aa9caa36a37b79e3e2160c41bf19460cf6706))
* **web:** dashboard and sleep reference pages with styling spec ([3e2dd33](https://github.com/Lory99/haelan/commit/3e2dd337201aca16d2b9afc190b6c8850d2aa4ed))
* **web:** deterministic fixtures, sparkline and heart rate range chart ([77d9a8f](https://github.com/Lory99/haelan/commit/77d9a8f34cd75e803f0cb9314ec3acac1034488f))
* **web:** distance and floors draw a labelled bar chart, side by side ([#181](https://github.com/Lory99/haelan/issues/181)) ([bf5620c](https://github.com/Lory99/haelan/commit/bf5620c3675c26bccb8d192716bf15b8d52e19f9))
* **web:** every chart says which day and what value, on hover ([#154](https://github.com/Lory99/haelan/issues/154)) ([82e758d](https://github.com/Lory99/haelan/commit/82e758d48d911d268ae32da9909bbbc1d39a4a35))
* **web:** four bands of active minutes that actually partition the day ([#210](https://github.com/Lory99/haelan/issues/210)) ([5f3a891](https://github.com/Lory99/haelan/commit/5f3a89141662344b76a19711b22ed5a1b943797d))
* **web:** hypnogram, sleep schedule and activity heatmap ([d1dd9a4](https://github.com/Lory99/haelan/commit/d1dd9a4deb60c01d444fd6dcfbda1f515e005796))
* **web:** M3a web foundations, so the reader can get in and the pages have something to stand on ([#64](https://github.com/Lory99/haelan/issues/64)) ([bef38a4](https://github.com/Lory99/haelan/commit/bef38a437513a008cad68899d9e7d65e972924e5))
* **web:** M3d-1 page spine, and the Dashboard reading real data ([#68](https://github.com/Lory99/haelan/issues/68)) ([ff00bed](https://github.com/Lory99/haelan/commit/ff00bed6eb06c6c1d81bf94a5191c1f605f7bca6))
* **web:** M3d-2 Activity, Sleep and Recovery, on one card that cannot lie ([#71](https://github.com/Lory99/haelan/issues/71)) ([bb0eca4](https://github.com/Lory99/haelan/commit/bb0eca4b3409a4c79bfffffcd77ff1569a651a1c))
* **web:** M7, the small screen ([#241](https://github.com/Lory99/haelan/issues/241)) ([e411caa](https://github.com/Lory99/haelan/commit/e411caaa1d26055536182fa48dd660b0f57a179e))
* **web:** one control row line on a phone, and sync moved to the shell ([#287](https://github.com/Lory99/haelan/issues/287)) ([c95c811](https://github.com/Lory99/haelan/commit/c95c81167dcd78b3be20b149d71cacf4c3fa19b8))
* **web:** real nav icons, no underline, larger type scale ([ee5eb05](https://github.com/Lory99/haelan/commit/ee5eb05fb3b7e5a1cf95858f7ca72ea406a7242c))
* **web:** rebrand to haelan and finish the app shell ([#10](https://github.com/Lory99/haelan/issues/10)) ([892e291](https://github.com/Lory99/haelan/commit/892e29171da50b9e5157749f2873a05febdc052b))
* **web:** resolve chart colours from tokens at render time ([f975be7](https://github.com/Lory99/haelan/commit/f975be714b5a27a7be3487c88ffba296dd61fbcf))
* **web:** rows that fill the width, and a rail foot with one way to your own page ([#334](https://github.com/Lory99/haelan/issues/334)) ([f4e840e](https://github.com/Lory99/haelan/commit/f4e840eb3b9f053733d64343a3e0df0faee20bd5))
* **web:** settings puts its narrow sections side by side ([#148](https://github.com/Lory99/haelan/issues/148)) ([8c82dd0](https://github.com/Lory99/haelan/commit/8c82dd07b5b212c2ddf0dbc3d9ded49e36633c67))
* **web:** settings split into your account and this instance ([#267](https://github.com/Lory99/haelan/issues/267)) ([e9efd2c](https://github.com/Lory99/haelan/commit/e9efd2ca1251c368b031d3e40d59a9682ad5a8a0))
* **web:** the mark is drawn from the tokens, and worn everywhere ([#162](https://github.com/Lory99/haelan/issues/162)) ([32d27ec](https://github.com/Lory99/haelan/commit/32d27ece7036fb4cb6f5171de761c9e387039308))
* **web:** the night page, and M8 closes with it ([#174](https://github.com/Lory99/haelan/issues/174)) ([f2bd818](https://github.com/Lory99/haelan/commit/f2bd818d0938e0955fb1ff7d0351ee082c2db3e0))
* **web:** the project links and the version move into a Settings card ([#260](https://github.com/Lory99/haelan/issues/260)) ([e014c2a](https://github.com/Lory99/haelan/commit/e014c2ad5e8451194cc29da69b7ff87c1589cdf1))
* **web:** the rebuild notice says how old it is ([#295](https://github.com/Lory99/haelan/issues/295)) ([e664c26](https://github.com/Lory99/haelan/commit/e664c262cff4d73c4ca71654a83cf85431b33143))
* **web:** the workout page, and the exclude control no browser could reach ([#172](https://github.com/Lory99/haelan/issues/172)) ([8fd36d5](https://github.com/Lory99/haelan/commit/8fd36d5b7f6c2392ac82b2293b3e82f49b4b9f93))
* **web:** tiles that are tiles, lists that stop at a measure, and figures that say what they are ([#258](https://github.com/Lory99/haelan/issues/258)) ([00a8855](https://github.com/Lory99/haelan/commit/00a88553749dbe84c0ef141a599e92ba14eabdda))


### Bug Fixes

* **android:** system bar insets, a header, and Obtainium's own badge ([#307](https://github.com/Lory99/haelan/issues/307)) ([5145353](https://github.com/Lory99/haelan/commit/5145353d6b59dfeb5929b941a8ae39bd5abb1a26))
* better-sqlite3 13, and the Node floor that actually made it fail ([#234](https://github.com/Lory99/haelan/issues/234)) ([5d39052](https://github.com/Lory99/haelan/commit/5d39052867a7435de7b9809b808161f3e984165c))
* **ci:** an Android release stops blocking every other release ([#335](https://github.com/Lory99/haelan/issues/335)) ([a2d0b30](https://github.com/Lory99/haelan/commit/a2d0b300b9f7aea18530f0f0eff0777e25891440))
* **ci:** create the app tag release-please skips, so an app release ships ([#317](https://github.com/Lory99/haelan/issues/317)) ([073140a](https://github.com/Lory99/haelan/commit/073140a9fe4495b38988413356a3b22f4f875a4f))
* **ci:** cut the release with the workflow's own token, not the PAT ([#184](https://github.com/Lory99/haelan/issues/184)) ([dd66111](https://github.com/Lory99/haelan/commit/dd6611155283ad12aac217b39937e39a450332e0))
* **ci:** put a version back in the release pull request title ([#312](https://github.com/Lory99/haelan/issues/312)) ([81df111](https://github.com/Lory99/haelan/commit/81df1112ee697625f08490e53021437a6a2328e3))
* **ci:** the release is a draft until its image is on the registry ([#183](https://github.com/Lory99/haelan/issues/183)) ([1b6e3ec](https://github.com/Lory99/haelan/commit/1b6e3ec154402f46d3f57418caa921dca8bfc149))
* close the M2 audit findings before M3 begins ([#62](https://github.com/Lory99/haelan/issues/62)) ([2ad42d4](https://github.com/Lory99/haelan/commit/2ad42d44d09ea61899c14711bf8034cc42aa3e94))
* **core,web:** say when a rebuild produced nothing, and stop the hook-timeout flake ([#291](https://github.com/Lory99/haelan/issues/291)) ([d1c8c38](https://github.com/Lory99/haelan/commit/d1c8c383ed290c16525c03925c8b9c9164392741))
* **core:** a body that repeats a session no longer costs a person their rebuild ([#277](https://github.com/Lory99/haelan/issues/277)) ([cacc225](https://github.com/Lory99/haelan/commit/cacc22525405aa70c19e56a0240b465915e8c976))
* **core:** insert a day's derived rows in chunks, not one statement each ([#283](https://github.com/Lory99/haelan/issues/283)) ([37fb04e](https://github.com/Lory99/haelan/commit/37fb04e9cefba3392fc139b4b2308def9b2c05fc)), closes [#275](https://github.com/Lory99/haelan/issues/275)
* **core:** prepare the sample upsert once instead of once per row ([#281](https://github.com/Lory99/haelan/issues/281)) ([efad634](https://github.com/Lory99/haelan/commit/efad6344c208965f67fd5b66dbdab58485e8da68)), closes [#275](https://github.com/Lory99/haelan/issues/275)
* **core:** reclaim the write-ahead log a rebuild leaves behind ([#102](https://github.com/Lory99/haelan/issues/102)) ([3ba2dc2](https://github.com/Lory99/haelan/commit/3ba2dc255485ec93943ba835ac70a9fa4ddda701))
* **core:** refuse a date the calendar does not have, in all three methods ([#52](https://github.com/Lory99/haelan/issues/52)) ([d390a69](https://github.com/Lory99/haelan/commit/d390a69d43c738309f578df069a575cd0b7383ea))
* **core:** replay archived payloads in the order they were fetched ([#58](https://github.com/Lory99/haelan/issues/58)) ([360e809](https://github.com/Lory99/haelan/commit/360e809f9d123f9f618c0ab967d5c6674b00ebb9))
* **demo:** let the demo's clock run, so charts draw ([#224](https://github.com/Lory99/haelan/issues/224)) ([4bbc84c](https://github.com/Lory99/haelan/commit/4bbc84c29104f5b8d3e99c2adef60301e4362cf9))
* make pnpm start mean what the documentation says ([#24](https://github.com/Lory99/haelan/issues/24)) ([3efcf49](https://github.com/Lory99/haelan/commit/3efcf4985beb40f9354582379aed47f41020cd9a))
* raise the Node floor to 22.13, which pnpm 11 requires ([64aea91](https://github.com/Lory99/haelan/commit/64aea91b8acaf8b534a77d2c3c61a9d5f753c6f9))
* release-please can find its own releases again, so the version stops being fiction ([#135](https://github.com/Lory99/haelan/issues/135)) ([46660de](https://github.com/Lory99/haelan/commit/46660dedecf07493e2952278236d90b466ce4f4f))
* run the server on stock Node, and prove it at boot ([#23](https://github.com/Lory99/haelan/issues/23)) ([5660c6f](https://github.com/Lory99/haelan/commit/5660c6fa48d72ea0bd15b401dbd92a5f53804d94))
* **server:** an upload derives one day per batch, not eight ([#310](https://github.com/Lory99/haelan/issues/310)) ([cb2fd00](https://github.com/Lory99/haelan/commit/cb2fd0098892ddd82f5597a9609057cf897085e3))
* **server:** close four setup routes the README already called protected ([#36](https://github.com/Lory99/haelan/issues/36)) ([a6798c7](https://github.com/Lory99/haelan/commit/a6798c7cb62c831ebbc29f6d3f0caf007d143bd8))
* **server:** resolving a session stops being a write, so a boot rebuild cannot take the instance down ([#206](https://github.com/Lory99/haelan/issues/206)) ([47ac840](https://github.com/Lory99/haelan/commit/47ac840787cb17b64633e7ffc000212170cc009b))
* **server:** scope sync status and its event stream to the caller's person ([#66](https://github.com/Lory99/haelan/issues/66)) ([da9e49a](https://github.com/Lory99/haelan/commit/da9e49a0acab0d943c05484a9137d37d89e76707))
* **server:** the boot rebuild runs in its own process, not a thread that can crash the server ([#187](https://github.com/Lory99/haelan/issues/187)) ([7c57c15](https://github.com/Lory99/haelan/commit/7c57c15c64393dbd9b1561a35b605c64d3c14521))
* **server:** the TOOLS.md drift test compares content, not line endings ([#151](https://github.com/Lory99/haelan/issues/151)) ([911f69e](https://github.com/Lory99/haelan/commit/911f69e667c39cf4705884420362796fc3ed5b8e))
* set allowBuilds.esbuild to true for pnpm 11.22 compatibility ([246a4ec](https://github.com/Lory99/haelan/commit/246a4ec580cc79bae5f70623e44d5a56415aa57c))
* **site:** link the demo from the front page, and make its deep links work ([#222](https://github.com/Lory99/haelan/issues/222)) ([4d14d0f](https://github.com/Lory99/haelan/commit/4d14d0fbd9cf7dd8b664c74b484942a7f225439f))
* **site:** the hero wash and the cap band run edge to edge ([#226](https://github.com/Lory99/haelan/issues/226)) ([6aaafeb](https://github.com/Lory99/haelan/commit/6aaafeb6345bfd600856149e616808120b431ef9))
* **sync:** raise the intraday cap to a year, and make it self-healing ([#28](https://github.com/Lory99/haelan/issues/28)) ([5aa5055](https://github.com/Lory99/haelan/commit/5aa5055d3c5324699197856f1abe5bdad393c764))
* **sync:** repair gaps after downtime, and stop three silent failures ([#31](https://github.com/Lory99/haelan/issues/31)) ([482bfe4](https://github.com/Lory99/haelan/commit/482bfe4b0b81f279c40a14f0288dd62358b3d8c8))
* **sync:** stop the cursor at a response body we cannot read ([#46](https://github.com/Lory99/haelan/issues/46)) ([3d1aac9](https://github.com/Lory99/haelan/commit/3d1aac94f4d8a6b4105523d03e9905f5374b0772))
* **test:** charts stop animating in tests, so flush() stops waiting them out ([#153](https://github.com/Lory99/haelan/issues/153)) ([ab7faa3](https://github.com/Lory99/haelan/commit/ab7faa32ebfd6838358f82fac8a07d8cf5502fe1))
* **test:** close the databases two test files were abandoning ([#300](https://github.com/Lory99/haelan/issues/300)) ([821133a](https://github.com/Lory99/haelan/commit/821133adf79098882462bb917177f390bad2e6e4))
* **test:** flush() waits on progress, and can tell a settled page from one that never started ([#202](https://github.com/Lory99/haelan/issues/202)) ([b914b71](https://github.com/Lory99/haelan/commit/b914b71e511487a79708746de2a0b81d14cdfbfd)), closes [#193](https://github.com/Lory99/haelan/issues/193)
* **test:** the MCP stdio test stops timing startup with a reply's budget ([#160](https://github.com/Lory99/haelan/issues/160)) ([d3f5b8f](https://github.com/Lory99/haelan/commit/d3f5b8f6320f6bb358897e60e41c5fcbdd677ef8))
* **test:** the source-trace tests wait for the render, not for flush()'s guess ([#197](https://github.com/Lory99/haelan/issues/197)) ([d13c41c](https://github.com/Lory99/haelan/commit/d13c41c647568e7439d60054220367c69955074d))
* **test:** the trace card waits for the fallback, not for flush()'s guess ([#199](https://github.com/Lory99/haelan/issues/199)) ([ca4d6cb](https://github.com/Lory99/haelan/commit/ca4d6cbb8545d279a8b1b7843464b49c1de3207c))
* **test:** the workout and night pages wait for a condition, not for flush()'s guess ([#180](https://github.com/Lory99/haelan/issues/180)) ([5345129](https://github.com/Lory99/haelan/commit/534512982d53bb63980246b03c17ad9367378baa))
* the container asks testers to report somewhere that carries the script ([#235](https://github.com/Lory99/haelan/issues/235)) ([b962b4a](https://github.com/Lory99/haelan/commit/b962b4a71aab36b2c67bf9654fcfe5235ae28cc0))
* the LXC data directory takes the name upstream documents ([#231](https://github.com/Lory99/haelan/issues/231)) ([e966c42](https://github.com/Lory99/haelan/commit/e966c429ac34ac41e02c7f44e709df36b5a9f900))
* the M2e follow ups, plus a shutdown that actually stops ([#56](https://github.com/Lory99/haelan/issues/56)) ([570c698](https://github.com/Lory99/haelan/commit/570c698ca3454262aa6a003509e143a8dc61bb9b))
* the M4 review's findings — a killable sandbox, bounded results, and writes that cannot fail a read ([#166](https://github.com/Lory99/haelan/issues/166)) ([241dd1a](https://github.com/Lory99/haelan/commit/241dd1a5cb51a857de05fb136d2676c5d461d384))
* the password form on the profile card says where it begins ([#146](https://github.com/Lory99/haelan/issues/146)) ([7570de9](https://github.com/Lory99/haelan/commit/7570de96f7cb52db29046e2b9dcd6767ba094d08))
* the projection sweep was deleting live queries' databases ([#167](https://github.com/Lory99/haelan/issues/167)) ([67e770a](https://github.com/Lory99/haelan/commit/67e770a8ef8ec8108479a2a13a81ca8a9822acb0))
* the seeded demo directory is gitignored, and its password is typeable ([#128](https://github.com/Lory99/haelan/issues/128)) ([9f40a5a](https://github.com/Lory99/haelan/commit/9f40a5aaa2984aa9062651a1681fb447baa2a0a3))
* the staleness read leaves the hot path, and reaches an agent ([#248](https://github.com/Lory99/haelan/issues/248)) ([3431c3d](https://github.com/Lory99/haelan/commit/3431c3d455d3099418675bb11a4490f10d4e3f2e))
* three defects found walking the setup flow end to end ([#25](https://github.com/Lory99/haelan/issues/25)) ([926b616](https://github.com/Lory99/haelan/commit/926b6163481c8448f5b32c5ab8a54ee7d29c54f1))
* **tokens:** close the accessibility gaps the token suite could not see ([#30](https://github.com/Lory99/haelan/issues/30)) ([9ad9cd7](https://github.com/Lory99/haelan/commit/9ad9cd74c207d6d7b1aa2c4d75234b15c7db9fc2))
* **tokens:** renumber primitives by lightness, add sequential scale, widen contrast cover ([a1fe658](https://github.com/Lory99/haelan/commit/a1fe65848cfae3cd92a14195549f5fa3d33e7418))
* **tokens:** resolve --text- prefix collision between colours and type scale ([d6e0346](https://github.com/Lory99/haelan/commit/d6e0346f960fda092687965215f01d094274c527))
* update Node engine to &gt;=22.6 and add pnpm configuration ([93d418b](https://github.com/Lory99/haelan/commit/93d418bcbddc804062313a936e923d53a2010863))
* **web,tokens:** separate delta direction from tone, distinguish no-data from grid ([2e139cd](https://github.com/Lory99/haelan/commit/2e139cd2be17dd1c57b4af13a52781e4135d4d5f))
* **web:** active zone minutes are a score, so stop calling them minutes ([#195](https://github.com/Lory99/haelan/issues/195)) ([04ec6b0](https://github.com/Lory99/haelan/commit/04ec6b0cb5ec2a386b0b53b3c1a377478ee3f18c))
* **web:** anchor excluded HR markers at actual mean, guard tooltip nulls ([9c0de62](https://github.com/Lory99/haelan/commit/9c0de6212175f710900125828e16b9ca5c4817f4))
* **web:** chart tooltips escape the text a reader typed ([#157](https://github.com/Lory99/haelan/issues/157)) ([7f29b78](https://github.com/Lory99/haelan/commit/7f29b78dc097607b3d11690b7e8f7581a45c5be5))
* **web:** do not hide a card on an exclusion list that has not arrived ([#298](https://github.com/Lory99/haelan/issues/298)) ([7b6fba5](https://github.com/Lory99/haelan/commit/7b6fba5b734e801f735e4a99554884b1198d3050))
* **web:** extract night-mark decision to a testable pure function ([91d71a0](https://github.com/Lory99/haelan/commit/91d71a0de013126865058424ab8cda3bb6ac1717))
* **web:** make flush() wait on isFetching, not a wall clock budget ([#70](https://github.com/Lory99/haelan/issues/70)) ([e9cfa64](https://github.com/Lory99/haelan/commit/e9cfa64e437bf4ce44815e87a0919c9e64a7ac89))
* **web:** one author for token names, shared chart base, accessible charts ([0b90358](https://github.com/Lory99/haelan/commit/0b903583c5550e35fff5fd87f0148768023fef35))
* **web:** render naps within the schedule axis, use chartVar for stage swatches, memoise heatmap layout ([7459bd3](https://github.com/Lory99/haelan/commit/7459bd31215da0c8b46a7b2b8f7241d26a538703))
* **web:** restrict visualMap to the heatmap series, add a page smoke test ([a5db9dd](https://github.com/Lory99/haelan/commit/a5db9dda7012c564e7d02fab28037e6e26db3a50))
* **web:** the about icon has a size, and the rail foot fits two sentences ([#326](https://github.com/Lory99/haelan/issues/326)) ([39ecea6](https://github.com/Lory99/haelan/commit/39ecea61f992872d37e7e09ac8b302fd904ef96d))
* **web:** the collapsed rail names its icons, and the stepper names the period instead of spelling its bounds ([#84](https://github.com/Lory99/haelan/issues/84)) ([cef9629](https://github.com/Lory99/haelan/commit/cef96293960a7d1c87290471b57fc710eba42049))
* **web:** the sparkline tooltip escapes the note a reader typed ([#177](https://github.com/Lory99/haelan/issues/177)) ([c5e2ee3](https://github.com/Lory99/haelan/commit/c5e2ee3d4830c1cfb58daca41e8bd534294d151f))
* **web:** the workout page's zone chart draws something ([#179](https://github.com/Lory99/haelan/issues/179)) ([39e4f72](https://github.com/Lory99/haelan/commit/39e4f72be118a48fe0f4e1db615324185244333d))


### Performance Improvements

* **core:** one date formatter per timezone, not one per probe ([#110](https://github.com/Lory99/haelan/issues/110)) ([40b6321](https://github.com/Lory99/haelan/commit/40b632196bff912ba86a7a6be604ee2874d61783))
* **sync:** sprint the recent window, and cap the types that cost the most ([#26](https://github.com/Lory99/haelan/issues/26)) ([55a0352](https://github.com/Lory99/haelan/commit/55a03520a38b883abd59c72a101f63f28450ab4a))
...
* **ci:** put a version back in the release pull request title ([#312](https://github.com/bardesss/haelan/issues/312)) ([81df111](https://github.com/bardesss/haelan/commit/81df1112ee697625f08490e53021437a6a2328e3))
