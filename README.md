...
The app ships English and Dutch, both complete at 968 keys. Locales are plain JSON
...
Adding one is three steps: copy `en.json`, translate its 968 keys, then import and register it
